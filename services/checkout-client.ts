import { PaymentMethod, PaymentSession } from "./payment-processors/types";
...
export async function createCheckoutSession(options: CheckoutSessionOptions): Promise<PaymentSession> {
  try {
...
export async function verifyPayment(sessionId: string, paymentMethod: PaymentMethod, userId?: string): Promise<boolean> {
  try {
