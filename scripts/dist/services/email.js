...
export class EmailService {
    ...
    getOrderConfirmationTemplate(data) {
        const { orderNumber, items, total, customerName, customerEmail, status, paymentMethod, paymentMethodTitle, shippingAddress, createdAt } = data;
    ...
    getPaymentReceiptTemplate(data) {
        const { orderNumber, total, paymentMethod, paymentMethodTitle, customerName, datePaid } = data;
    ...
    getMembershipActivationTemplate(data) {
        const { membershipName, validUntil, customerName, orderNumber, total } = data;
    ...
    getStatusUpdateTemplate(data) {
        const { orderNumber, newStatus, customerName, items, total, shippingAddress } = data;
      ...
      <html>
        ...
        <body>
          <div class="email-container">
            ...
            <div class="content">
              <p>Hallo ${customerName},</p>
              <p>${statusMessages[newStatus] || 'Der Status Ihrer Bestellung wurde aktualisiert'}.</p>
    ...
    async sendEmail(template, emailData) {
        try {
